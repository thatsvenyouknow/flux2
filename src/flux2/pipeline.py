...
class Flux2Pipeline:
    ...
    def __init__(
        ...
        #Allow TF32 for matmuls — speedup on Ampere+ GPUs, negligible precision loss
    ...
    def outpainting(
        ...
        The mask has three zones:
          ...
          2. Overlap zone: a strip of the original that gets regenerated by the
             ...
             it produces visually similar content here, so the seam
             between "regenerated original" and "real original" is less visible.
        ...
        #Condition the model on the original image (Note: removed canvas mask, as did not seem to help)
